                ...
                data.map(item=>{
                    return(
                        <div className="card home-card" key={item._id}>
                            <h5 style={{padding:"5px"}}><p style={{margin:"0px"}}><Link to={(state._id != item.postedBy._id) ? "/profile/"+item.postedBy._id:"/profile"}><img src={item.postedBy.pic} style={{borderRadius:"50%",height:"30px",width:"30px",verticalAlign:"middle",marginRight:"5px"}}/>{item.postedBy.name}</Link> {state._id == item.postedBy._id 
